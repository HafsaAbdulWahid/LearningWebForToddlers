...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <!-- Prophet Ibrahim (AS): Start -->
        <div class="container-xxl py-5">
            <div class="container px-lg-5">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-7 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="section-title position-relative mb-4 pb-4">
                            <h3 class="mb-2">Prophet Ibrahim (AS)</h3>
                        </div>
                        <p class="mb-4" style="text-align:justify;  text-justify:inter-word;">Prophet Ibrahim, is a very
                            important person in the stories of different
                            religions. He lived a long, long time ago. Ibrahim was a friend of God, and he always tried
                            to do what God wanted him to do. One day, God asked Ibrahim to leave his home and go to a
                            new place. It was a big adventure.
                        </p>

                        <p class="mb-4" style="text-align:justify;  text-justify:inter-word;">Ibrahim had a special
                            family, too. His wife Sarah and their son Isma'il were with him. God blessed them with a lot
                            of love. One amazing story about Ibrahim is that he was willing to do whatever God asked,
                            even if it was hard. There's a story about him building a special house called the Kaaba
                            with his son Isma'il. Kids from all around the world learn about Prophet Ibrahim because he
                            teaches us about love, trust, and doing the right thing, even when it's tough.
                        </p>
                    </div>
                    <div class="col-lg-5 mb-5">
                        <img class="img-fluid wow zoomIn rounded" data-wow-delay="0.5s" src="img/pic30.jpg"
                ...
                <div class="col-lg-5 mt-5">
                    ...
                    <?php
                    $sql = "SELECT * FROM videos WHERE title = 'Prophet Ibrahim (AS) Story'";
                    include('videos.php');
                    ?>
