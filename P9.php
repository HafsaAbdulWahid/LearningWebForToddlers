...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <!-- Prophet Ayub (AS): Start -->
        <div class="container-xxl py-5">
            <div class="container px-lg-5">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-7 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="section-title position-relative mb-4 pb-4">
                            <h3 class="mb-2">Prophet Ayub (AS)</h3>
                        </div>
                        <p class="mb-4" style="text-align:justify;  text-justify:inter-word;">Prophet Ayub (AS) is a
                            special person in the stories from long ago. He was a very good man who loved and obeyed
                            Allah a lot. Allah gave him a happy life with a big family, many animals, and a nice home.
                            But one day, Allah wanted to test Prophet Ayub to see if he would still love Him, even if
                            things became difficult.</p>

                        <p class="mb-4" style="text-align:justify;  text-justify:inter-word;">Prophet Ayub got sick, and
                            it was not easy for him. He had to be patient and strong. Even when he was not feeling well,
                            he never stopped believing in Allah and being a good person. His story teaches us about
                            patience and trusting Allah, no matter what happens in our lives. Eventually, because of his
                            strong faith, Allah blessed Prophet Ayub with good health, and he became even happier than
                            before. So, Prophet Ayub's story is a reminder that no matter what, we should always trust
                            Allah and be patient, just like he did.
                        </p>
                    </div>
                    <div class="col-lg-5 mb-5">
                        <img class="img-fluid wow zoomIn rounded" data-wow-delay="0.5s" src="img/pic33.jpg"
                ...
                <div class="col-lg-5 mt-5">
                    ...
                    <?php
                    $sql = "SELECT * FROM videos WHERE title = 'Prophet Ayub (AS) Story'";
                    include('videos.php');
                    ?>
