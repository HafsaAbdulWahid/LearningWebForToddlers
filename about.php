            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="domain.html" class="nav-item nav-link">Quiz</a>
                        <a href="hosting.html" class="nav-item nav-link">Blog</a>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Lessons</a>
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-7 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="section-title position-relative mb-4 pb-4">
                            <h1 class="mb-2">Welcome to Kutuby</h1>
                        </div>
                        <p class="mb-4">Kutuby is a professional platform on the internet to learn Quran, Arabic
                            Language, and Islamic Studies for kids. We use advanced technology and new teaching
                            techniques to make the learning of the Quran, Arabic, or Islam online much more effective
                            and interactive. We also customizes courses, lessons, and teaching techniques as per
                            student’s age, knowledge, and interests. So, no matter your level or age, your
                            children can start learning Quran & Arabic without any hassle.</p>
                        <div class="row g-3">
                            ...
                            <div class="col-sm-4 wow fadeIn" data-wow-delay="0.5s">
                                <div class="bg-light rounded text-center p-4">
                                    <i class="fa fa-thumbs-up fa-2x text-primary mb-2"></i>
                                    <h2 class="mb-1" data-toggle="counter-up">250</h2>
                                    <p class="mb-0">Satisfied Parents</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <img class="img-fluid wow zoomIn" data-wow-delay="0.5s" src="img/pic5.jpg">
                    </div>
                </div>
            </div>
        </div>
