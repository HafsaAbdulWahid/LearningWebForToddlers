            ...
            <div class="container my-5 py-5 px-lg-5">
                <div class="row g-5 pt-5">
                    <div class="col-12 text-center text-lg-start">
                        <h1 class="display-4 text-white animated slideInLeft">Level Three</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center justify-content-lg-start animated slideInLeft">
                                <li class="breadcrumb-item"><a class="text-white" href="index.php">Home</a></li>
                                <li class="breadcrumb-item text-white active" aria-current="page">Level Three</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container-xxl py-5">
        <div class="container px-lg-5">
            <div class="section-title position-relative text-center mx-auto mb-5 pb-4 wow fadeInUp"
                ...
                <h1 class="mb-3">Kalmats & Phrases</h1>
            </div>
            <div class="row gy-5 gx-4">
                <div class="levelCard col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="position-relative shadow rounded border-top border-5 border-primary">
                        ...
                        <div class="text-center border-bottom p-4 pt-5">
                            <h4 class="fw-bold">Kalma</h4>
                            <p class="mb-0">Eirmod erat dolor amet est clita lorem erat justo rebum elitr eos</p>
                            <a href="kalma.php" class="level-btn btn btn-primary px-4 mx-auto my-2"><i
                ...
                <div class="levelCard col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="position-relative shadow rounded border-top border-5 border-primary">
                        ...
                        <div class="text-center border-bottom p-4 pt-5">
                            <h4 class="fw-bold">Asma Ul Husna</h4>
                            <p class="mb-0">Eirmod erat dolor amet est clita lorem erat justo rebum elitr eos</p>
                            <a href="" class="level-btn btn btn-primary px-4 mx-auto my-2"><i
                                    class="fa fa-arrow-right" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
                <div class="levelCard col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="position-relative shadow rounded border-top border-5 border-primary">
                        ...
                        <div class="text-center border-bottom p-4 pt-5">
                            <h4 class="fw-bold">Asma Un Nabi</h4>
                            <p class="mb-0">Eirmod erat dolor amet est clita lorem erat justo rebum elitr eos</p>
                            <a href="" class="level-btn btn btn-primary px-4 mx-auto my-2"><i
                                    class="fa fa-arrow-right" aria-hidden="true"></i></a>
                        </div>
            ...
            <div class="row gy-5 gx-4 mt-3">
                <div class="levelCard col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="position-relative shadow rounded border-top border-5 border-primary">
                        ...
                        <div class="text-center border-bottom p-4 pt-5">
                            <h4 class="fw-bold">Masnoon Duas</h4>
                            <p class="mb-0">Eirmod erat dolor amet est clita lorem erat justo rebum elitr eos</p>
                            <a href="MasnoonDuas.php" class="level-btn btn btn-primary px-4 mx-auto my-2"><i
                                    class="fa fa-arrow-right" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
                <div class="levelCard col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="position-relative shadow rounded border-top border-5 border-primary">
                        ...
                        <div class="text-center border-bottom p-4 pt-5">
                            <h4 class="fw-bold">Salaat</h4>
                            <p class="mb-0">Eirmod erat dolor amet est clita lorem erat justo rebum elitr eos</p>
                            <a href="Salaat.php" class="level-btn btn btn-primary px-4 mx-auto my-2"><i
                                    class="fa fa-arrow-right" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
                <div class="levelCard col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="position-relative shadow rounded border-top border-5 border-primary">
                        ...
                        <div class="text-center border-bottom p-4 pt-5">
                            <h4 class="fw-bold">Islamic Months</h4>
                            <p class="mb-0">Eirmod erat dolor amet est clita lorem erat justo rebum elitr eos</p>
                            <a href="" class="level-btn btn btn-primary px-4 mx-auto my-2"><i
                                    class="fa fa-arrow-right" aria-hidden="true"></i></a>
                        </div>
            ...
            <div class="row pb-3">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="card border-0 shadow-sm mb-2">
                        <img class="card-img-top mb-2" src="img/blog-2.jpg" alt="">
                        <div class="card-body bg-light text-center p-4">
                            <h4 class="fw-bold mb-1">Islam</h4>
                            <p>Sed kasd sea sed at elitr sed ipsum justo, sit nonumy diam eirmod, duo et sed sit
                                eirmod kasd clita tempor dolor stet lorem. Tempor ipsum justo amet stet...</p>
                            <a href="" class="btn btn-primary px-4 mx-auto my-2">Read More</a>
                        </div>
